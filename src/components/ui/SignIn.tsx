...
export default function SignIn() {
  ...
  return (
    <div className="w-[700px] bg-gradient-to-b from-slate-800 to-teal-800 py-12 px-4 sm:px-6 lg:px-8 flex items-center justify-center rounded-3xl">
      <div className="relative max-w-md w-full space-y-8 bg-Logoay-800/70 backdrop-blur-sm p-8 rounded-xl border border-teal-400/20 shadow-2xl shadow-teal-400/10">
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            type="button"
            className="flex items-center justify-center py-2 px-4 border border-gray-600 rounded-lg text-sm font-medium text-slate-300 hover:bg-gray-700/50 transition-colors">
            <span className="mr-2">G</span> Google
          </button>
          <button
            type="button"
            className="flex items-center justify-center py-2 px-4 border border-gray-600 rounded-lg text-sm font-medium text-slate-300 hover:bg-gray-700/50 transition-colors">
            <span className="mr-2">🎮</span> Game Center
          </button>
        </div>
      </div>
    </div>
